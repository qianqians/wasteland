...
export class gate_client_service {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.reconnect != null) {
            output.writeFieldBegin("reconnect", thrift.Type.STRUCT, 2);
            this.reconnect.write(output);
            output.writeFieldEnd();
        }
        if (this.request_hub_service != null) {
            output.writeFieldBegin("request_hub_service", thrift.Type.STRUCT, 3);
            this.request_hub_service.write(output);
            output.writeFieldEnd();
        }
        if (this.call_rpc != null) {
            output.writeFieldBegin("call_rpc", thrift.Type.STRUCT, 4);
            this.call_rpc.write(output);
            output.writeFieldEnd();
        }
        if (this.call_rsp != null) {
            output.writeFieldBegin("call_rsp", thrift.Type.STRUCT, 5);
            this.call_rsp.write(output);
            output.writeFieldEnd();
        }
        if (this.call_err != null) {
            output.writeFieldBegin("call_err", thrift.Type.STRUCT, 6);
            this.call_err.write(output);
            output.writeFieldEnd();
        }
        if (this.call_ntf != null) {
            output.writeFieldBegin("call_ntf", thrift.Type.STRUCT, 7);
            this.call_ntf.write(output);
            output.writeFieldEnd();
        }
        if (this.heartbeats != null) {
            output.writeFieldBegin("heartbeats", thrift.Type.STRUCT, 8);
