...
export class client_service {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.create_remote_entity != null) {
            output.writeFieldBegin("create_remote_entity", thrift.Type.STRUCT, 1);
            this.create_remote_entity.write(output);
            output.writeFieldEnd();
        }
        if (this.delete_remote_entity != null) {
            output.writeFieldBegin("delete_remote_entity", thrift.Type.STRUCT, 2);
            this.delete_remote_entity.write(output);
            output.writeFieldEnd();
        }
        if (this.refresh_entity != null) {
            output.writeFieldBegin("refresh_entity", thrift.Type.STRUCT, 3);
            this.refresh_entity.write(output);
            output.writeFieldEnd();
        }
        if (this.conn_id != null) {
            output.writeFieldBegin("conn_id", thrift.Type.STRUCT, 4);
            this.conn_id.write(output);
            output.writeFieldEnd();
        }
        if (this.kick_off != null) {
            output.writeFieldBegin("kick_off", thrift.Type.STRUCT, 5);
            this.kick_off.write(output);
            output.writeFieldEnd();
        }
        if (this.transfer_complete != null) {
            output.writeFieldBegin("transfer_complete", thrift.Type.STRUCT, 6);
            this.transfer_complete.write(output);
            output.writeFieldEnd();
        }
        if (this.call_rpc != null) {
            output.writeFieldBegin("call_rpc", thrift.Type.STRUCT, 7);
            this.call_rpc.write(output);
            output.writeFieldEnd();
        }
        if (this.call_rsp != null) {
            output.writeFieldBegin("call_rsp", thrift.Type.STRUCT, 8);
            this.call_rsp.write(output);
            output.writeFieldEnd();
        }
        if (this.call_err != null) {
            output.writeFieldBegin("call_err", thrift.Type.STRUCT, 9);
            this.call_err.write(output);
            output.writeFieldEnd();
        }
        if (this.call_ntf != null) {
            output.writeFieldBegin("call_ntf", thrift.Type.STRUCT, 10);
            this.call_ntf.write(output);
            output.writeFieldEnd();
        }
        if (this.call_global != null) {
            output.writeFieldBegin("call_global", thrift.Type.STRUCT, 11);
            this.call_global.write(output);
            output.writeFieldEnd();
        }
        if (this.heartbeats != null) {
            output.writeFieldBegin("heartbeats", thrift.Type.STRUCT, 12);
