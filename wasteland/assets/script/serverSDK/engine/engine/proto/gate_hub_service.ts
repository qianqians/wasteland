...
export class gate_hub_service {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.reg_server != null) {
            output.writeFieldBegin("reg_server", thrift.Type.STRUCT, 1);
            this.reg_server.write(output);
            output.writeFieldEnd();
        }
        if (this.reg_server_callback != null) {
            output.writeFieldBegin("reg_server_callback", thrift.Type.STRUCT, 2);
            this.reg_server_callback.write(output);
            output.writeFieldEnd();
        }
        if (this.create_remote_entity != null) {
            output.writeFieldBegin("create_remote_entity", thrift.Type.STRUCT, 3);
            this.create_remote_entity.write(output);
            output.writeFieldEnd();
        }
        if (this.delete_remote_entity != null) {
            output.writeFieldBegin("delete_remote_entity", thrift.Type.STRUCT, 4);
            this.delete_remote_entity.write(output);
            output.writeFieldEnd();
        }
        if (this.refresh_entity != null) {
            output.writeFieldBegin("refresh_entity", thrift.Type.STRUCT, 5);
            this.refresh_entity.write(output);
            output.writeFieldEnd();
        }
        if (this.call_rpc != null) {
            output.writeFieldBegin("call_rpc", thrift.Type.STRUCT, 6);
            this.call_rpc.write(output);
            output.writeFieldEnd();
        }
        if (this.call_rsp != null) {
            output.writeFieldBegin("call_rsp", thrift.Type.STRUCT, 7);
            this.call_rsp.write(output);
            output.writeFieldEnd();
        }
        if (this.call_err != null) {
            output.writeFieldBegin("call_err", thrift.Type.STRUCT, 8);
            this.call_err.write(output);
            output.writeFieldEnd();
        }
        if (this.call_ntf != null) {
            output.writeFieldBegin("call_ntf", thrift.Type.STRUCT, 9);
            this.call_ntf.write(output);
            output.writeFieldEnd();
        }
        if (this.call_global != null) {
            output.writeFieldBegin("call_global", thrift.Type.STRUCT, 10);
            this.call_global.write(output);
            output.writeFieldEnd();
        }
        if (this.kick_off != null) {
            output.writeFieldBegin("kick_off", thrift.Type.STRUCT, 11);
            this.kick_off.write(output);
            output.writeFieldEnd();
        }
        if (this.kick_off_complete != null) {
            output.writeFieldBegin("kick_off_complete", thrift.Type.STRUCT, 12);
            this.kick_off_complete.write(output);
            output.writeFieldEnd();
        }
        if (this.transfer != null) {
            output.writeFieldBegin("transfer", thrift.Type.STRUCT, 13);
            this.transfer.write(output);
            output.writeFieldEnd();
        }
        if (this.transfer_complete != null) {
            output.writeFieldBegin("transfer_complete", thrift.Type.STRUCT, 14);
            this.transfer_complete.write(output);
            output.writeFieldEnd();
        }
        if (this.wait_migrate_entity != null) {
            output.writeFieldBegin("wait_migrate_entity", thrift.Type.STRUCT, 15);
            this.wait_migrate_entity.write(output);
            output.writeFieldEnd();
        }
        if (this.migrate_entity_complete != null) {
            output.writeFieldBegin("migrate_entity_complete", thrift.Type.STRUCT, 16);
            this.migrate_entity_complete.write(output);
            output.writeFieldEnd();
        }
        if (this.client_remove_remote_entity != null) {
            output.writeFieldBegin("client_remove_remote_entity", thrift.Type.STRUCT, 17);
