...
export class battle_ntf_client_module {
    ...
    public on_use_skill:((s:engine.session, skill_id:number, dir:common.direction, pos:common.position) => void)[] = [];
    public on_harm:((s:engine.session, skill_id:number, dir:common.direction, pos:common.position, harm_type:common.em_harm_type, harm_value:number) => void)[] = [];
