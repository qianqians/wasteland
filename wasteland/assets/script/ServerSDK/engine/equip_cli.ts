...
export class equip_wear_equip_cb {
    ...
    public cb:((equips:Array<common.equip_info>) => void)|null = null;
    ...
    private on_rsp(bin:Uint8Array) {
        ...
        if (this.cb) this.cb.call(null, _equips);
    ...
    public callBack(_cb:(equips:Array<common.equip_info>) => void, _err:(err:common.error_code) => void) {
        this.cb = _cb;
        this.err = _err;
