...
class login_module(object):
    def __init__(self, entity:player|entity):
        ...
        self.on_create_character:list[Callable[[login_create_character_rsp, str, int, int, str], None]] = []
